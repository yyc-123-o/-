...
def _build_learning_scope(kg: KnowledgeGraph, current_chapter_id: str = "ch01_foundation", mastery_map: Dict[str, float] = None) -> LearningScope:
    """构建章节级学习范围"""
...
def build_profile(
    learner: Learner,
    kg: KnowledgeGraph,
    current_chapter_id: str = "ch01_foundation",
) -> LearnerProfile:
