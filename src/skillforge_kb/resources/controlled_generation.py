...
class ControlledResourceGenerationService:
    ...
    def __init__(
        ...
        *,
        retry_on_audit_failure: bool = True,
    ) -> None:
        self._adapter = adapter
        self._auditor = auditor or ResourceAuditor()
        self._retry_on_audit_failure = retry_on_audit_failure
    ...
    def generate(
        ...
        for attempt in (1, 2):
            try:
                ...
                if (
                    audit.audit_status is AuditStatus.FAILED
                    and attempt == 1
                    and self._retry_on_audit_failure
                ):
